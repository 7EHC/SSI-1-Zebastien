...
import { UserPlusIcon, PencilSquareIcon, TrashIcon, UserIcon } from '@heroicons/vue/24/solid'
...
<template>
  ...
  <!-- <div class="profile" style="float: right;border-radius: 10px;background-color: #1a1a1d;">
      ...
      <div class="table-parent" style="margin-right: 15px;">
          ...
          <RouterLink :to="{name: 'SasAddUser'}"><button id="addBut" style="float: right;"><UserPlusIcon style="height: 20px;"/></button></RouterLink>
          </div>
          <div class="bigTable">
              <table>
                  <tr class="tableHead">
                  ...
                  <tr v-for="(usr, index) in user" :key="index" class="ann-item">
                    ...
                    <td class="ann-button-td">
                      <button class="ann-button" id="edit-button" @click="goToEdit(usr.id)"><PencilSquareIcon style="height: 15px;"/></button>
                      <button class="ann-button" id="delete-button" @click="changeConfirm(usr.id)"><TrashIcon style="height: 15px;"/></button>
                    </td>
                  </tr>
              </table>  
          </div>
